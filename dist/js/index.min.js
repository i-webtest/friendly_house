...
"use strict";$(".burger").on("click",(function(){$(".burger, .navigation").toggleClass("active"),$("body").toggleClass("lock")}));var deleteClass=function(){$(".burger, .navigation").hasClass("active")&&($(".burger, .navigation").removeClass("active"),$("body").removeClass("lock"))};$(".navigation__link").on("click",deleteClass),$(".order").on("click",deleteClass),$(document).on("click",(function(a){var e=a.target;$(".burger, .navigation").hasClass("active")&&($(e).parents(".navigation__list").length||$(e).hasClass("navigation__list")||$(e).hasClass("burger")||($(".burger, .navigation").removeClass("active"),$("body").removeClass("lock")))})),$(document).on("keyup",(function(a){"Escape"==a.key&&deleteClass()}));
"use strict";var width=document.documentElement.clientWidth,imageSlider=document.querySelector(".help__image-slider"),imageWrapper=document.querySelector(".help__image-wrapper"),image1=document.querySelector(".help__image-01"),image2=document.querySelector(".help__image-02"),image3=document.querySelector(".help__image-03"),swiperOn=function(){imageSlider.classList.add("swiper1"),imageWrapper.classList.add("swiper-wrapper"),image1.classList.add("swiper-slide"),image2.classList.add("swiper-slide"),image3.classList.add("swiper-slide"),image1.style.width="200px",image2.style.width="193px",image3.style.width="170px",new Swiper(".swiper1",{slidesPerView:"auto",spacebetween:10,freeMode:!0,keyboard:{enabled:!0}})},helpSlider=document.querySelector(".help__slider"),sliderWrapper=document.querySelector(".help__slider-wrapper"),slider1=document.querySelector(".help__slide-01"),slider2=document.querySelector(".help__slide-02"),slider3=document.querySelector(".help__slide-03"),swiperOn2=function(){helpSlider.classList.add("swiper2"),sliderWrapper.classList.add("swiper-wrapper"),slider1.classList.add("swiper-slide"),slider2.classList.add("swiper-slide"),slider3.classList.add("swiper-slide"),slider1.style.width="130px",slider2.style.width="225px",slider3.style.width="218px",new Swiper(".swiper2",{slidesPerView:"auto",spacebetween:10,freeMode:!0,keyboard:{enabled:!0}})};width<=720&&(swiperOn(),swiperOn2());var petsSlider=document.querySelector(".pets__slider"),petsGrid=document.querySelector(".pets__grid"),petsSlides=document.querySelectorAll(".pets__item"),petsSwiper=function(){petsSlider.classList.add("swiper3"),petsGrid.classList.add("swiper-wrapper"),petsSlides.forEach((function(e){e.classList.add("swiper-slide")})),new Swiper(".swiper3",{slidesPerView:"1",spacebetween:20,centeredSlides:!0,keyboard:{enabled:!0},navigation:{nextEl:".pets-button-next",prevEl:".pets-button-prev"},effect:"fade",fadeEffect:{crossFade:!0}})};width<=1023&&petsSwiper();
"use strict";var map=L.map("map").setView([55.848271,37.37536],16);L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(map),L.marker([55.848271,37.37536]).addTo(map).bindPopup("Friendly House - приют для животных").openPopup();
"use strict";var scrollController={scrollPosition:0,disabledScroll:function(){scrollController.scrollPosition=window.scrollY,document.body.style.cssText="\n      overflow: hidden;\n      position: fixed;\n      top: -".concat(scrollController.scrollPosition,"px;\n      left:0;\n      height: 100vh;\n      width: 100vw;\n      padding-right: ").concat(window.innerWidth-document.body.offsetWidth,"px;\n    "),document.documentElement.style.scrollBehavior="unset"},enabledScroll:function(){document.body.style.cssText="",window.scroll({top:scrollController.scrollPosition}),document.documentElement.style.scrollBehavior=""}},overlay=$(".modal"),modal=$(".modal__main"),modalBtn=$(".order"),modalClose=$(".modal__close"),openModal=function(){overlay.show(500),scrollController.disabledScroll()},closeModal=function(){overlay.hide(500),scrollController.enabledScroll()};modalBtn.click((function(){openModal()})),modalClose.click((function(){closeModal()})),overlay.click((function(o){$(o.target).parents(".modal__main").length||$(o.target).hasClass("modal__main")||closeModal()})),$(document).on("keyup",(function(o){"Escape"==o.key&&closeModal()}));
"use strict";var tabsList=document.querySelector(".hero__list"),tabsItem=document.querySelectorAll(".hero__item"),backgroundContainer=document.querySelector(".hero__container"),num=0,tabBtn=function(){var t="";if(tabsItem.forEach((function(e){e.classList.contains("hero__item-active")&&(t=e)})),""!==t)return t},background=function(t){var e=tabBtn(),o=t.querySelector(".hero__figcaption").textContent,n=t.dataset.bg,r=document.querySelector(".hero__title-name");void 0!==tabBtn()&&(num+=1,e.style.order="".concat(num),e.classList.remove("hero__item-active")),t.classList.add("hero__item-active"),r.textContent=o,backgroundContainer.style.backgroundImage="url('".concat(n,"')")};tabsList.addEventListener("click",(function(t){var e=t.target;e.closest(".hero__item")&&background(e.closest(".hero__item"))}));
"use strict";var inputTel=document.querySelector(".form__input-phone"),telMask=new Inputmask("+7 (999)-999-99-99");telMask.mask(inputTel);var formTitle=document.querySelector(".feedback__title"),modalFieldset=document.querySelector(".form__fieldset"),justValidate=new JustValidate(".form");justValidate.addField(".form__input-phone",[{rule:"required",errorMessage:"Укажите ваш телефон"},{validator:function(e){var t=inputTel.inputmask.unmaskedvalue();return!(!Number(t)||10!==t.length)},errorMessage:"Укажите корректный номер"}]).addField(".form__input-mail",[{rule:"required",errorMessage:"Укажите ваш E-mail"}]).onSuccess((function(e){var t=e.target;axios.post("https://jsonplaceholder.typicode.com/posts",{mail:t.mail.value,phone:t.phone.value}).then((function(e){t.reset(),formTitle.textContent="Спасибо ваша заявка принята, номер заявки ".concat(e.data.id,"!")})).catch((function(e){console.error(e),t.reset(),formTitle.textContent="Что-то пошло не так, попробуйте позже!"}))}));
"use strict";var inputPhone=document.querySelector(".form__input-phone__modal"),phoneMask=new Inputmask("+7 (999)-999-99-99");phoneMask.mask(inputPhone);var modalTitle=document.querySelector(".modal__title"),validate=new JustValidate(".form-modal");validate.addField(".form__input-phone__modal",[{rule:"required",errorMessage:"Укажите ваш телефон"},{validator:function(e){var t=inputPhone.inputmask.unmaskedvalue();return!(!Number(t)||10!==t.length)},errorMessage:"Укажите корректный номер"}]).addField(".form__input-mail__modal",[{rule:"required",errorMessage:"Укажите ваш E-mail"}]).onSuccess((function(e){var t=e.target;axios.post("https://jsonplaceholder.typicode.com/posts",{mail:t.mail.value,phone:t.phone.value}).then((function(e){t.reset(),modalTitle.textContent="Спасибо ваша заявка принята, номер заявки ".concat(e.data.id,"!")})).catch((function(e){console.error(e),t.reset(),modalTitle.textContent="Что-то пошло не так, попробуйте позже!"}))}));