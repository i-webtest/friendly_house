...
{const e=document.documentElement.clientWidth,t=document.querySelector(".help__image-slider"),s=document.querySelector(".help__image-wrapper"),r=document.querySelector(".help__image-01"),d=document.querySelector(".help__image-02"),l=document.querySelector(".help__image-03"),i=()=>{t.classList.add("swiper1"),s.classList.add("swiper-wrapper"),r.classList.add("swiper-slide"),d.classList.add("swiper-slide"),l.classList.add("swiper-slide"),r.style.width="200px",d.style.width="193px",l.style.width="170px",new Swiper(".swiper1",{slidesPerView:"auto",spacebetween:10,freeMode:!0,keyboard:{enabled:!0}})},c=document.querySelector(".help__slider"),a=document.querySelector(".help__slider-wrapper"),o=document.querySelector(".help__slide-01"),p=document.querySelector(".help__slide-02"),n=document.querySelector(".help__slide-03"),u=()=>{c.classList.add("swiper2"),a.classList.add("swiper-wrapper"),o.classList.add("swiper-slide"),p.classList.add("swiper-slide"),n.classList.add("swiper-slide"),o.style.width="130px",p.style.width="225px",n.style.width="218px",new Swiper(".swiper2",{slidesPerView:"auto",spacebetween:10,freeMode:!0,keyboard:{enabled:!0}})};e<=720&&(i(),u());const w=document.querySelector(".pets__slider"),y=document.querySelector(".pets__grid"),m=document.querySelectorAll(".pets__item");e<=1023&&(()=>{w.classList.add("swiper3"),y.classList.add("swiper-wrapper"),m.forEach((e=>{e.classList.add("swiper-slide")})),new Swiper(".swiper3",{slidesPerView:"1",spacebetween:20,centeredSlides:!0,keyboard:{enabled:!0},navigation:{nextEl:".pets-button-next",prevEl:".pets-button-prev"},effect:"fade",fadeEffect:{crossFade:!0}})})()}(()=>{const e=document.querySelector(".burger"),t=document.querySelector(".navigation"),s=t.querySelectorAll(".navigation__link"),r=document.querySelector("body"),d=()=>{e.classList.toggle("active"),t.classList.toggle("active"),r.classList.toggle("lock")};e.addEventListener("click",d),s.forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault(),d();let t=e.target.getAttribute("href").substring(1);const s=document.getElementById(t).getBoundingClientRect().top-0;window.scrollBy({top:s,behavior:"smooth"})}))}))})();
export const burgerMenu=()=>{const e=document.querySelector(".burger"),t=document.querySelector(".navigation"),o=t.querySelectorAll(".navigation__link"),c=document.querySelector("body"),n=()=>{e.classList.toggle("active"),t.classList.toggle("active"),c.classList.toggle("lock")};e.addEventListener("click",n),o.forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault(),n();let t=e.target.getAttribute("href").substring(1);const o=document.getElementById(t).getBoundingClientRect().top-0;window.scrollBy({top:o,behavior:"smooth"})}))}))};
